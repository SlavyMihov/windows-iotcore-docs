...
The turnkey security scripts generate SIPolicyOn.p7b and SIPolicyOff.p7b files in the folder.
...
If you create a package that takes the SIPolicyOff.p7b file and places it as a SIPolicy.p7b, and then applies this package, the Device Guard will be turned off.
